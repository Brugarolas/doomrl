...
@BHOWDY FROM THE QUEEREST BASTARD AROUND, I rewrote all of the flavour text and UI text. Depending on when you're seeing this, it might not be done yet, so bear with me. If you want to find me, my discord username is DaxSystem#1312 and my Twitch channel is DaxSystem.
